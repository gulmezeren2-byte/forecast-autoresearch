...
Single metric: **FVA vs naive (WMAPE points; higher is better)**. Best holdout FVA so far: **+8.13**. Protocol `13e6b1b0e0e6`.

| run_at_utc       | label               |   dev_fva |   holdout_fva |   forecasts | model_sha    | ⚑   | note                                                            |
|:-----------------|:--------------------|----------:|--------------:|------------:|:-------------|:----|:----------------------------------------------------------------|
| 2026-07-14 11:16 | agent               |      4.33 |          8.13 |         288 | 9ddeede246fa |     | C2: in-history window selection for intermittent branch         |
| 2026-07-14 11:04 | agent               |      4.19 |          8.01 |         288 | 9d163071c4aa |     | C2: per-series alpha (in-history grid), branch back to 12m mean |
